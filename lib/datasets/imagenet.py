...
class imagenet(imdb):
    ...
    def image_path_from_index(self, index):
        ...
        """
	#index[:23] just for ImageNet2013 val.txt (det_lists)
    ...
    def _load_imagenet_annotation(self, index):
        ...
        """
        filename = os.path.join(self._devkit_path, 'ILSVRC2014_DET_bbox_' + self._image_set, index + '.xml')
...
#Cuc Nguyen
	...
	annopath = os.path.join(self._devkit_path, 'ILSVRC2014_DET_bbox_' + self._image_set, '{:s}.xml')
